...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요",\
        ...
        ) # 최초에 사용자가 지정한 경로를 보여줌 # r을 쓰면 탈출 문자를 사용하지 않겠다 라는 말
...
def browse_dest_path():
    ...
    if forder_selected is None: # 사용자가 취소를 누를 때
        return
    # print(forder_selected)
...
def merge_image():
    ...
    dest_path = os.path.join(txt_dest_path.get(), "d582_photo.jpg")
